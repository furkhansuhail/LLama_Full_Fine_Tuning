...
Gradient accumulation is the workaround: you get the mathematical benefit of a larger batch without the memory cost, at the expense of taking 8× more forward passes per update.
"""