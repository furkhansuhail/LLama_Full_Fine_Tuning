...
#
#
# Which Tokenizer We're Using ?
# The model unsloth/Llama-3.2-1B-Instruct uses Llama 3's tiktoken-based BPE tokenizer with a vocabulary of 128,256 tokens.
#
# How are we loading the data:
# tokenizer = AutoTokenizer.from_pretrained("unsloth/Llama-3.2-1B-Instruct")
#
# This downloads a few small files (the vocab, merge rules, and special token config) — not the model weights.
# The critical thing is that you must use the same tokenizer the model was pre-trained with. Using a different tokenizer
# would produce garbage because the model learned to associate specific token IDs with specific meanings during pre-training.
#
#
#
# """
